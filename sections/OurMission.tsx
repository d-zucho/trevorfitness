  ...
  return (
    <section className='py-20'>
      <MaxWidthWrapper>
        ...
        {/* button 2 */}
        <div className='relative inline-flex h-12 overflow-hidden rounded-full p-[1px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-my-primary'>
          <span className='absolute inset-[-1000%] animate-[spin_4s_linear_infinite] bg-[conic-gradient(from_90deg_at_50%_50%,#f47521_0%,#222_0%,#f47521_100%)] opacity-80 blur-sm' />
